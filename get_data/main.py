...
def chuck_data():
    ...
    try:
        ...
        required_tables = [
            ...
            'tczq_match_result', 'tczq_odds_change_log',
            # 北京单场 (BJDC)
            'bjdc_match', 'bjdc_spf_odds', 'bjdc_handicap_spf_odds',
            'bjdc_ht_ft_odds', 'bjdc_total_goal_odds', 'bjdc_score_odds',
            'bjdc_up_down_odds', 'bjdc_match_result', 'bjdc_odds_change_log',
            # 竞彩篮球 (TCBK)
            'tcbk_league', 'tcbk_match', 'tcbk_spf', 'tcbk_rfsf', 'tcbk_dxf', 'tcbk_sfc',
            'tcbk_result', 'tcbk_odds_history', 'tcbk_odds_history_spf',
            'tcbk_odds_history_rfsf', 'tcbk_odds_history_dxf', 'tcbk_odds_history_sfc',
            'bk_odds_change_log',
            # 数字彩
            'digital_lottery_draws', 'digital_lottery_prizes', 
            'digital_lottery_term_lists', 'digital_lottery_types'
        ]
