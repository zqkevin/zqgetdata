...
def map_to_internal_status(source_type: str, source_status) -> int:
    ...
    if source_type == 'bjdc':
        ...
        return bjdc_map.get(str(source_status), 2)  # 默认已完成
        ...
        return tczq_map.get(str(source_status), 2)  # 默认已完成
        ...
        return jcbk_map.get(source_status, 2)  # 默认已完成
