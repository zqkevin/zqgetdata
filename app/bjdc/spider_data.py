...
from app.common._utils import req_info, check_zq_win_pl
        ...
        try:
            ...
            for match in need_update_matchs:
                try:
                    ...
                    log.error(f'Error processing match {match.homename} vs {match.awayname}: {traceback.format_exc()}')
        except Exception as e:
